function [x, y, max_intensity] = get_intensity(dir_)
%dir_ = 'G:\JHU\EN. 601.656 Computer Integrated Surgery 2\PA_buf1500'; % use full path of the folder storing .daq files
bFreqFilter_ = 1;
